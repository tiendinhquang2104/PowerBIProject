...
## Examine the problem
- Are there significant differences in academic performance between the two graduation periods?
  Differences Between Graduation Cohorts: In the third cohort, no student graduated with an "Excellent" rating—only 3% achieved a "Good" rating and 7.44% received a "Fair" rating. In contrast, the fourth cohort experienced a dramatic shift, with 58% of students earning an "Excellent" rating, 23% a "Good" rating, and the percentage of "Fair" ratings dropping to 5.82%. This significant discrepancy may be attributed to changes in assessment criteria, exam difficulty, or teaching methods between the cohorts, thereby raising concerns about the objectivity and consistency of the evaluation system
- Which majors consistently produce high-achieving graduates, and - which may need further academic support?
  Finance and Banking Performance: In the third graduation cohort, the Finance and Banking major recorded the highest number of students graduating with a "Good" rating, with 23 graduates. This trend continued in the fourth cohort, where the major again led the pack by having 202 students earn a "Good" rating. This consistency may indicate a well-established curriculum and effective teaching methods in the Finance and Banking program, though it also calls for a review of the evaluation criteria to ensure that the high performance accurately reflects student achievement

Business Administration vs. Agricultural Business: When considering both graduation cohorts together, the Business Administration major produced the highest number of "Excellent" graduates, totaling 483 students. In stark contrast, the Agricultural Business major had the fewest "Excellent" graduates, with only 2 students reaching this top tier. This significant discrepancy suggests that while Business Administration is excelling in fostering high-achieving students, Agricultural Business may need a critical reassessment of its curriculum, teaching strategies, and academic support services to better enhance student outcomes

Accounting Performance: The Accounting major showed a distinct pattern by having the highest number of students, 136 in total, graduating with a "Fair" rating. This indicates that although the program may be maintaining a consistent level of overall performance, there appears to be a challenge in pushing students beyond the "Fair" category to higher achievement levels, warranting the introduction of additional support mechanisms and more rigorous academic interventions
